...
<epp xmlns="urn:ietf:params:xml:ns:epp-1.0">
  <response>
    ...
    def test_parse_fee21_check_response_multiple_fees(self):
        # RFC 8748's commandDataType allows <fee:fee> to repeat
        # (maxOccurs="unbounded"), e.g. a registration fee plus a separate
        # premium fee line. Both must be preserved, not just the last one.
        self.assertResponse({
            'avails':      {'example.com': '1'},
            'clTRID':      'ABC-12345',
            'extensions':  [],
            ...
            'fee': {
                'example.com': {
                    ...
                    'unit':    'y',
                    'fee': [
                        {'value': '10.00', 'description': 'Registration Fee'},
                        {'value': '90.00', 'description': 'Premium Fee', 'refundable': '0'},
                    ],
                },
            },
        }, '''<?xml version="1.0" encoding="utf-8"?>
      ...
      <fee:chkData xmlns:fee="urn:ietf:params:xml:ns:fee-0.21">
        <fee:cd avail="1">
          ...
          <fee:command name="create">
            ...
            <fee:fee description="Premium Fee" refundable="0">90.00</fee:fee>
          </fee:command>
        </fee:cd>
      </fee:chkData>
    </extension>
