...
class TestFee12Check(TestCase):

    def test_parse_fee12_check_response(self):
        # fee12 inherits fee11's <fee:object><domain:name> identifier
        # structure, but lowercases attribute values it copies into data
        # (see fee12.parse_cd vs fee11.parse_cd).
        self.assertResponse({
